...
c      
     ...
     +cn*fdoco*foa+faa*foo)/fdoco/foa*kpd*sp(18,j)-(faa*foo/fdoco/foa*sp
     +(3,j)-faa/foa*sp(4,j)+sp(5,j)+fcn*sp(9,j)-faa*foo/fdoco/foa/fnitra
     +*fdocn*sp(10,j)+fcn*sp(13,j)+fcn*sp(14,j)-faa/fsulph*fdocs*foo/fdo
     +co/foa*sp(15,j)+fcn*sp(16,j)+fcn*sp(17,j)+fcn*sp(20,j)+fcn*sp(21,j
     +)+fcn*sp(22,j)+fcn*sp(23,j))/delt+(faa*foo/fdoco/foa*spold(3,j)-fa
     +a/foa*spold(4,j)+spold(5,j)+fcn*spold(9,j)-faa*foo/fdoco/foa/fnitr
     +a*fdocn*spold(10,j)+fcn*spold(13,j)+fcn*spold(14,j)-faa/fsulph*fdo
     +cs*foo/fdoco/foa*spold(15,j)+fcn*spold(16,j)+fcn*spold(17,j)+fcn*s
     +pold(20,j)+fcn*spold(21,j)+fcn*spold(22,j)+fcn*spold(23,j))/delt
     ...
     ++sp(5,j))/(exp(0.1D2*(0.1D0*amming-sp(5,j))/st/amming)+1)-(sp(1,j)
     ++sp(2,j)+1/fcn*faa*foo/fdoco/foa*sp(3,j)-1/fcn*faa/foa*sp(4,j)+1/f
     +cn*sp(5,j)+sp(6,j)+sp(7,j)+sp(8,j)+sp(9,j)-1/fcn*faa*foo/fdoco/foa
     +/fnitra*fdocn*sp(10,j)+sp(13,j)+sp(14,j)-1/fcn*faa/fsulph*fdocs*fo
     +o/fdoco/foa*sp(15,j)+sp(16,j)+sp(17,j)+sp(18,j)+sp(20,j)+sp(21,j)+
     +sp(22,j)+sp(23,j))/delt+(spold(1,j)+spold(2,j)+1/fcn*faa*foo/fdoco
     +/foa*spold(3,j)-1/fcn*faa/foa*spold(4,j)+1/fcn*spold(5,j)+spold(6,
     +j)+spold(7,j)+spold(8,j)+spold(9,j)-1/fcn*faa*foo/fdoco/foa/fnitra
     +*fdocn*spold(10,j)+spold(13,j)+spold(14,j)-1/fcn*faa/fsulph*fdocs*
     +foo/fdoco/foa*spold(15,j)+spold(16,j)+spold(17,j)+spold(18,j)+spol
     +d(20,j)+spold(21,j)+spold(22,j)+spold(23,j))/delt
     ...
     +.1D0*amming-sp(5,j))/st/amming)+1)-(sp(1,j)+sp(2,j)+1/fcn*faa*foo/
     ...
     +sp(4,j)))/st/ammin)+1)-fsulph/fdocs*kpd*sp(18,j)-(-fsulph/fdocs*sp
     +(3,j)+fsulph/fdocs/foo*fdoco*sp(4,j)+fsulph/fnitra*fdocn/fdocs*sp(
     +10,j)+sp(15,j))/delt+(-fsulph/fdocs*spold(3,j)+fsulph/fdocs/foo*fd
     +oco*spold(4,j)+fsulph/fnitra*fdocn/fdocs*spold(10,j)+spold(15,j))/
     +delt
     ...
     +/st/amming)+1)-(sp(1,j)+sp(2,j)+1/fcn*faa*foo/fdoco/foa*sp(3,j)-1/
     +fcn*faa/foa*sp(4,j)+1/fcn*sp(5,j)+sp(6,j)+sp(7,j)+sp(8,j)+sp(9,j)-
     +1/fcn*faa*foo/fdoco/foa/fnitra*fdocn*sp(10,j)+sp(11,j)+sp(12,j)+sp
     ...
     +11,j)+spold(12,j)+spold(13,j)+spold(14,j)-1/fcn*faa/fsulph*fdocs*f
     +oo/fdoco/foa*spold(15,j)+spold(16,j)+spold(17,j)+spold(18,j)+spold
     +(20,j)+spold(21,j)+spold(22,j)+spold(23,j))/delt
