...
c      
     ...
     +j)/(ksox+sp(4,j)))/st/doxmin)+faa/foa*(1-1/(exp(0.25D1*(0.4D0-ws)/
     +st)+1))+faa/foa/delt
     ...
     +exp((ammin-kmax4*sp(5,j)/(ksamm+sp(5,j))*sp(4,j)/(ksox+sp(4,j)))/s
     +t/ammin)-fsulph/fdocs/foo*fdoco*(1-1/(exp(0.25D1*(0.4D0-ws)/st)+1)
     +)-fsulph/fdocs/foo*fdoco/delt
         pd(3,23) = 0
         pd(10,11) = 0
         pd(16,5) = 0
     ...
     +sp(4,j))*sp(10,j)/(ksno3+sp(10,j))*sp(3,j)/(ksndoc+sp(3,j)))/st/no
     +3min)+1/fcn*faa/foa*(1-1/(exp(0.25D1*(0.4D0-ws)/st)+1))+1/fcn*faa/
     +foa/delt
     ...
     +,j))/st/Bfmax)*sp(9,j)
         pd(3,11) = 0
         pd(18,4) = 1/fcn*faa/foa*(1-1/(exp(0.25D1*(0.4D0-ws)/st)+1))+1/
     +fcn*faa/foa/delt
     ...
     +n*faa/foa*(1-1/(exp(0.25D1*(0.4D0-ws)/st)+1))+1/fcn*faa/foa/delt
         pd(19,3) = 0
